...
contract BBN2Presale is Ownable {
    IERC20 public token;
    IERC20Metadata public tokenMetadata;
    AggregatorV3Interface public priceFeed;
    address public paymentAddress;
    uint256 public presaleTokenAmount = 2000000000000000000000000000;
    ...
    constructor(
        ...
        // stage data
        stages[1] = Stage(1, 50, 3000000000000000, 1750976700, 1750977300); //stage 1
        stages[2] = Stage(2, 35, 5000000000000000, 1750977301, 1750977600); //stage 2
        stages[3] = Stage(3, 30, 6000000000000000, 1750977601, 1750977900); //stage 3
        stages[4] = Stage(4, 22, 7000000000000000, 1750977901, 1750978200); //stage 4
        stages[5] = Stage(5, 15, 8000000000000000, 1751063701, 1751064000); //stage 1
        stages[6] = Stage(6, 12, 9000000000000000, 1751064001, 1751064300); //stage 2
        stages[7] = Stage(7, 10, 10000000000000000, 1751064301, 1751064600); //stage 3
        stages[8] = Stage(8, 10, 12000000000000000, 1751064601, 1751064900); //stage 4
        stages[9] = Stage(9, 8, 15000000000000000, 1751064901, 1751065200); //stage 4
        currentStageId = 9;
    }
